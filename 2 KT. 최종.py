...
print(df)
# 경기장 별 승률 불러오기
KT_data = pd.read_csv('KT_data.csv',encoding='euc-kr')
print(KT_data)
# df와 csv 데이터 머지
merged = df.set_index('경기장').join(KT_data.set_index('경기장'))
...
# 마커 색상을 구분할 수 있게 지정
colors = ["#191919", "#353535", "#5D5D5D", "#8C8C8C", "#A6A6A6", "#BDBDBD", "#D5D5D5", "#EAEAEA", "#F6F6F6"]
...
# 지도 저장
m.save("kbo_team_distance_ktmap2_default_size_icons.html")